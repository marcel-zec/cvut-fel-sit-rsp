...
//        tripSessionDao.persist(tripSession);
        ...
        String description =" himenaeos amet lorem in, cursus sodales erat. Vivamus suscipit felis et ex pulvinar, vitae rutrum diam tempus. ";
        Trip trip = new Trip("Archeology of Zabgre",10,description,"moje",4999,"Zagreb, Croatia",4);
        tripDao.persist(trip);
        TripSession tripSession = new TripSession(trip,LocalDate.parse("2018-07-14"), LocalDate.parse("2018-08-21"),2500);
        tripSessionDao.persist(tripSession);
